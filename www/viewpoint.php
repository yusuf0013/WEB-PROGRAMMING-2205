                    ...
                    while($row = $result->fetch_assoc()){
                      ...
                      <tr><td>
                         <?php echo $j; ?>
                                ...
                                <?php echo $row["Totalunits"]; ?>
                                </td>
                                <td>
                                <?php echo $row["Totalpoints"]; ?></td>
                                <td>
                                <?php echo $row["Gp"].".0"; ?></td>
                                </tr><br>
                               <?php 
                               $j++;
                                 }
...
<?php 
          ...
          <div class="row mt-3 mb-3">
                      <div class="col-4"></div>
                      <div class="col-4"> 
                       <p>Sorry you don't have result in the database goback to home </p>                     
